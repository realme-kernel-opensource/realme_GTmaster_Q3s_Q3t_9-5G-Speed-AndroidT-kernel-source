...
static void aw8692x_misc_para_init(struct aw_haptic *aw_haptic)
{
	...
	i2c_w_bits(aw_haptic, AW8692X_REG_TRIMCFG1,
		   (uint8_t)AW8692X_BIT_TRIMCFG1_RL_TRIM_SRC_MASK,
		   (uint8_t)AW8692X_BIT_TRIMCFG1_RL_TRIM_SRC_REG);
	reg_val = AW8692X_BIT_ANACFG7_INIT_VAL;
	i2c_w_bytes(aw_haptic, AW8692X_REG_ANACFG7, &reg_val,
		    AW_I2C_BYTE_ONE);
