...
#define HAPTIC_HV_DRIVER_VERSION	"v0.0.0.1"
...
static DEVICE_ATTR(duration, S_IWUSR | S_IWGRP, duration_show, duration_store);
static DEVICE_ATTR(activate, S_IWUSR | S_IWGRP, activate_show, activate_store);
				   ...
				   unsigned long arg)
{
	...
	case RICHTAP_RTP_MODE:
		...
		aw_haptic->func->set_bst_vol(aw_haptic, 0x11);
		aw_haptic->func->play_mode(aw_haptic, AW_RTP_MODE);
		aw_haptic->func->play_go(aw_haptic, true);
		usleep_range(2000, 2500);
		aw_haptic->func->set_rtp_data(aw_haptic,
