...
#define AW_HAPTIC_HIGH_LEVEL_REG_VAL		(0x18)
...
#define AW8692X_BST_VOL_DEFAULT			(0x58)
#define AW8692X_BST_VOL_RAM			(0x58)
#define AW8692X_BST_VOL_RTP			(0x58)
...
#define AW8692X_0815_CONT_DRV2_LVL		(0x50)
