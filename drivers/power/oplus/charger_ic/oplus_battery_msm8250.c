...
/* wangshu@BSP.CHG.Basic, 2020/04/07, Add for OTG use external boost */
...
#else
/* Brian@PSW.BSP.CHG.Basic,2021/8/11, Modify for using mp2650 to suspend usb about sm8250 */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*wangshu@BSP.CHG.Basic, 2021/04/21, support huawei nonstandard typec cable*/
...
/* wangshu@BSP.CHG.Basic, 2021/05/26 use the usbin_v_chan with low voltage charger */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* LiYue@BSP.CHG.Basic, 2021/01/04, add for charger */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* wangshu@BSP.CHG.Basic, 2021/03/23, Add for usbtemp */
#ifdef OPLUS_CUSTOM_OP_DEF
