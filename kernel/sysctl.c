...
unsigned long sysctl_sched_assist_scene = 0;
#endif /* defined(OPLUS_FEATURE_SCHED_ASSIST) && defined(CONFIG_OPLUS_FEATURE_SCHED_ASSIST) */
...
/* Foreground background optimization,change max io count */
	...
	},
	{
		...
		.maxlen		= sizeof(sysctl_sched_assist_scene),
		.mode		= 0666,
	...
	},
	{
		...
		.maxlen 	= sizeof(int),
		.mode		= 0666,
		.proc_handler = sysctl_sched_boost_task_threshold_handler,
	},
	{
		...
		.maxlen		= sizeof(int),
		.mode		= 0666,
		.proc_handler = sysctl_sched_animation_type_handler,
	},
	{
		.procname	= "frame_rate",
