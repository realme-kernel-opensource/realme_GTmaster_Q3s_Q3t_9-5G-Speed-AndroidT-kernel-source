...
#define MAX_CAM_SENSOR_SETTING_ARRAY_NUM  4600

struct cam_sensor_i2c_reg_setting_array {
	struct cam_sensor_i2c_reg_array reg_setting[MAX_CAM_SENSOR_SETTING_ARRAY_NUM];
	unsigned short size;
...
struct cam_sensor_settings {
	...
	struct cam_sensor_i2c_reg_setting_array ov8d10_setting;
